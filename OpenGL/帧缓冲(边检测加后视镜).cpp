...
int main()
{
	...
	Shader screenShader("F:/vs2013/C++project/OpenGL/shader/Framebuffervs.txt", "F:/vs2013/C++project/OpenGL/shader/Framebufferfrag.txt");
...
#pragma region "object_initialization"
	...
	// Load textures
	GLuint cubeTexture = loadTexture("F:/vs2013/C++project/OpenGL/texture/container.jpg");
...
#pragma endregion
	...
	//创建第二个帧缓冲
	// Framebuffers
	GLuint framebuffermirror;
	glGenFramebuffers(1, &framebuffermirror);
	glBindFramebuffer(GL_FRAMEBUFFER, framebuffermirror);
	// Create a color attachment texture
	GLuint textureColorbuffer1 = generateAttachmentTexture(false, false);
...
#pragma region "rearview mirror render"
		/////////////////////////////////////////////////////
		// Bind to framebuffer and draw to color texture 
		// as we normally would.
		// //////////////////////////////////////////////////
...
#pragma endregion
	...
	glDeleteFramebuffers(1, &framebuffermirror);
